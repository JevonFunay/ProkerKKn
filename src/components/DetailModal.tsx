            ...
            <div className="overflow-y-auto overscroll-contain flex-1">
              ...
              <div className="p-6 sm:p-8 space-y-6">
                ...
                >
                  <button
                    onClick={onClose}
                    className="w-full inline-flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white font-semibold px-6 py-3.5 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer"
                  >
                    Tutup Detail
                  </button>
                </motion.div>
